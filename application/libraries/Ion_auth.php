		...
		else
		{
			...
			if(!$this->config->item('use_ci_email', 'ion_auth'))
			{
				...
				$this->set_message('activation_email_successful');
                                ...
                                $message = $this->twig->render($this->config->item('email_templates', 'ion_auth') . $this->config->item('email_activate', 'ion_auth'), $data);
                                $this->load->library('SwiftMailer');
                                $this->swiftmailer->setSubject($this->config->item('site_title', 'ion_auth') . ' - ' . $this->lang->line('email_activation_subject'));
                                $this->swiftmailer->setRecipient($email);
