...
class Migration_Install_ion_auth extends CI_Migration {
    ...
    public function up() {
        ...
        $data = array(
            ...
            'username' => 'admin',
            'password' => '$2y$08$/0nPiW/UoxbxzubE0DTsGOzPrqO1uNhRgoQblhcN17FpB5CNo5TqC',
            'salt' => '',
        ...
        // Drop table 'users_groups' if it exists		
        $this->dbforge->drop_table('user_openid');
        ...
        $this->dbforge->add_key('openid', TRUE);
        $this->dbforge->create_table('user_openid');
